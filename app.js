...
const nearBus = require("./api/routes/nearest");
...
app.get("/getLocation", (req, res) => {
  res.json({
    lat: [28.7212416, 28.7212416, 28.7205876, 28.7205876, 28.7202913],
    long: [77.1404606, 77.1404606, 77.1404016, 77.1404016, 77.1403479]
  });
});
